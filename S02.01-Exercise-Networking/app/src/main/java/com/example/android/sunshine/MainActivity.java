...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        //dummyWeatherData declaration is deleted
         ...
         */
        //deleted the for loop which callas the dummyWeatherData
    ...
    void loadWeatherData() {
        String preferdlocation;
        preferdlocation = SunshinePreferences.getPreferredWeatherLocation(this);
        //https://stackoverflow.com/questions/31874990/async-task-android-execute
        WeatherTask task = new WeatherTask();
        task.execute(preferdlocation);
    }
    // TODO (5) Create a class that extends AsyncTask to perform network requests
    public class WeatherTask extends AsyncTask<String, Void, String[]> {
        // TODO (6) Override the doInBackground method to perform your network requests
        //https://stackoverflow.com/questions/43187936/newtworkutils-getresponsefromhttpurl
        @Override
        protected String[] doInBackground(String... params) {
            ...
            URL RequestUrl = NetworkUtils.buildUrl(spot);
            try {
    ...
    //for loop that populates the TextView with dynamic data //(3) is completed so we implemented that here
            //https://stackoverflow.com/questions/5390605/async-task-android-onpostexecute
